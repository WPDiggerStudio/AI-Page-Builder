 ...
 * User Meta Storage
 *
 * Handles storage and retrieval of field values as WordPress user meta.
 *
 * @package WPJarvis\Framework\WP\Fields\Storage
 */
class UserMetaStorage implements StorageInterface {
	/**
	 * Get a field value from user meta.
	 *
	 * @param string $objectId User ID.
	...
	public function get( string $objectId, string $fieldKey, string $context ): mixed {
		$value = get_user_meta( (int) $objectId, $fieldKey, true );
	...
	/**
	 * Set a field value in user meta.
	 *
	 * @param string $objectId User ID.
	 * @param string $fieldKey Field key.
	...
	public function set( string $objectId, string $fieldKey, mixed $value, string $context ): bool {
		return update_user_meta( (int) $objectId, $fieldKey, $value );
	}

	/**
	 * Delete a field value from user meta.
	 *
	 * @param string $objectId User ID.
	 * @param string $fieldKey Field key.
	 * @param string $context Storage context.
	...
	public function delete( string $objectId, string $fieldKey, string $context ): bool {
		return delete_user_meta( (int) $objectId, $fieldKey );
	}

	/**
	 * Get multiple field values from user meta.
	 *
	 * @param string $objectId User ID.
	...
	/**
	 * Set multiple field values in user meta.
	 *
	 * @param string $objectId User ID.
	...
	/**
	 * Delete multiple field values from user meta.
	 *
	 * @param string $objectId User ID.
	 * @param array<string> $fieldKeys Field keys.
	 * @param string $context Storage context.
