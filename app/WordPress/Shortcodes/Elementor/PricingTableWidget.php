...
class PricingTableWidget extends ElementorWidget {
	...
	public function get_title(): string {
		return __( 'Pricing Table', 'bra-calculator' );
	}
	...
	public function get_keywords(): array {
		return [ 'pricing_table', 'shortcode', 'pricing-table' ];
	}
