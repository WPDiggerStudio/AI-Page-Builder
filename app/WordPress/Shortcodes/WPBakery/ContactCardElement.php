...
/**
 * ContactCardElement - WPBakery/Visual Composer element adapter for ContactCard shortcode.
 *
 * Automatically generates vc_map() params from a shortcode attribute schema.
 *
 * @package BraCalculator\\App\WordPress\Shortcodes\WPBakery
 */
class ContactCardElement extends WPBakeryElement {
	/**
