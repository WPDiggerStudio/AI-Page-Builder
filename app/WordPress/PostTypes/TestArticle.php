...
/**
 * TestArticle post-type
 *
 * Registers and manages Test Article custom post-type.
 *
...
class TestArticle {
	 ...
	 * The post-type slug.
	 */
	public const SLUG = 'test_article';

	/**
	 * The singular label.
	 */
	public const SINGULAR = 'Test Article';

	/**
	 * The plural label.
	 */
	public const PLURAL = 'Test Articles';
