...
class TestTask extends Task {
	 ...
	 */
	protected string $description = 'Test Task Task';
	...
	public function handle(): mixed {
		...
		try {
			...
			// Log success
			$this->log( 'TestTask completed successfully.' );

			return $result;
		} catch ( \Throwable $e ) {
			// Log error
			$this->log( 'TestTask failed: ' . $e->getMessage(), 'error' );
			throw $e;
		}
	}
	...
	public function handleFailure( \Throwable $e ): void {
		...
		//     __('Scheduled Task Failed', 'bra-calculator'),
